...
"""
def author():
        return 'pbutler33' # replace sroutray3 with your Georgia Tech username.

def gtid():
    return 903532401 # replace with your GT ID number
...
#############################################
            ...
            new_scores = np.add(np.multiply(node_weights, 1-damping_factor), new_scores)
            scores = new_scores
#############################################
